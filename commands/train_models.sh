...
BASE_DIR="/home/lily/jt856/documents/simplex-diffusion/"
...
# params_for_simple_data="--model_name_or_path roberta-large --per_device_train_batch_size 24 --per_device_eval_batch_size 6 --do_train --do_eval  --evaluation_strategy steps --eval_steps 1000 --report_to tensorboard --overwrite_output_dir --max_seq_length 50 --max_eval_samples 48 --simplex_value 5 --num_diffusion_steps 5000 --num_inference_diffusion_steps 1000 --lr_scheduler_type linear --learning_rate 1e-4 --pad_to_max_length --beta_schedule squaredcos_improved_ddpm --weight_decay 0.01  --top_p 0.99 --max_steps 60000 --gradient_accumulation_steps 1 --warmup_steps 2000 --logging_steps 50 --save_steps 1000     --train_file /home/lily/jt856/documents/diffusion/small_data/simple-train.txt --validation_file /home/lily/jt856/documents/diffusion/small_data/simple-test.txt"

params_for_simple_data="--model_name_or_path allenai/longformer-base-4096 --per_device_train_batch_size 8 --per_device_eval_batch_size 6 --do_train --do_eval  --evaluation_strategy steps --eval_steps 1000 --report_to tensorboard --overwrite_output_dir --max_seq_length 50 --max_eval_samples 48 --simplex_value 5 --num_diffusion_steps 5000 --num_inference_diffusion_steps 1000 --lr_scheduler_type linear --learning_rate 1e-4 --pad_to_max_length --beta_schedule squaredcos_improved_ddpm --weight_decay 0.01  --top_p 0.99 --max_steps 60000 --gradient_accumulation_steps 1 --warmup_steps 2000 --logging_steps 50 --save_steps 1000     --train_file /home/lily/jt856/documents/diffusion/small_data/simple-train.txt --validation_file /home/lily/jt856/documents/diffusion/small_data/simple-test.txt"
...
# DEBUG MODEL
#python  -m torch.distributed.launch --nproc_per_node 4 run_mlm.py --output_dir "/data/outputs/paper_experiments/debug" ${shared_params} ${DEBUG_PARAMS}   ${PARAMS_FOR_LOCAL} --eval_steps 400 --temperature 1.0  --tokenized_data_path  "/home/lily/jt856/documents/simplex-diffusion/processed_data/openwebtext_256_split" --eval_steps 30 --compute_eval_loss_with_simplex True --self_condition "logits_mean" --ssdlm_optimizer --conditional_generation "ul2_variable" ${DEBUG_PARAMS} --evaluation_strategy steps --max_eval_samples 10 --save_steps 2 --save_steps 2 --save_checkpoints_on_s3
