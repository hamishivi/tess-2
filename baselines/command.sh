...
max_steps=60000
# max position embedding for BART is 1024, so we do not need to resize it.
checkpoint="/net/nfs.cirrascale/s2-research/rabeehk/outputs/paper_experiments/summarization_results/baseline_lr_"${learning_rate}"_steps_"${max_steps}"/checkpoint-60000"
